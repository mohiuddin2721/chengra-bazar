        ...
        <div className={`bg-[#240838] duration-500 ${hide && 'hidden'} ${visible ? 'h-auto px-5 py-[10px]' : 'h-0 px-0 py-0'} text-[13px] font-medium tracking-wide leading-[26px] text-white`}>
            <div className='flex justify-center relative'>
                <div className='flex-wrap flex justify-center items-center gap-2 px-[10px]'>
                    ...
                    {/* <button type='button' className={`bg-[#240838] ${!visible && 'hidden'} hover:bg-opacity-50 duration-300 px-2 py-[3px] leading-5 text-[10px] font-sans font-bold`}>MEN</button>
                    <button type='button' className={`bg-[#240838] ${!visible && 'hidden'} hover:bg-opacity-50 duration-300 px-2 py-[3px] leading-5 text-[10px] font-sans font-bold`}>WOMEN</button> */}
                    <small className='font-normal opacity-50 md:hidden'>* Limited time only.</small>
                </div>
                <TfiClose onClick={() => {
                    setVisible(false);
